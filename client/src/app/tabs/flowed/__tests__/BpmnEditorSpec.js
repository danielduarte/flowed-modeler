...
describe('<FlowedEditor>', function() {
  ...
  describe('caching behavior', function() {
    ...
    beforeEach(function() {
      createSpy = sinon.spy(FlowedEditor, 'createCachedState');
    });
  ...
  describe('plugins', function() {
    ...
    it('should accept plugins', async function() {
      ...
      const {
        ...
        getPlugins(type) {
          switch (type) {
          case 'flowed.modeler.additionalModules':
            return [ additionalModule ];
          case 'flowed.modeler.moddleExtension':
    ...
    it('should handle invalid moddle extensions', async function() {
      ...
      // then
      expect(() => FlowedEditor.createCachedState(props)).to.not.throw();
  ...
  describe('import', function() {
    ...
    it('should not import when provided xml is the same as the cached one', async function() {
      ...
      // given
      const isImportNeededSpy = sinon.spy(FlowedEditor.prototype, 'isImportNeeded');
      const cache = new Cache();
  ...
  describe('extensions event emitting', function() {
    ...
    it('should notify when modeler configures', async function() {
      ...
      // then
      const modelerConfigureEvent = getEvent(emittedEvents, 'flowed.modeler.configure');
...
const TestEditor = WithCachedState(FlowedEditor);
...
async function renderEditor(xml, options = {}) {
  ...
  const instance = wrapper.find(FlowedEditor).instance();
